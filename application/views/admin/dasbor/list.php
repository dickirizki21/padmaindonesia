											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="layouts-left-sidebar-panel-light.html#">(view all)</a>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="card-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="layouts-left-sidebar-panel-light.html#">(withdraw)</a>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="card-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="layouts-left-sidebar-panel-light.html#">(statement)</a>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="card-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													...
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="layouts-left-sidebar-panel-light.html#">(report)</a>
													</div>
												</div>
											</div>
										</div>
							...
							<section class="card">
								<header class="card-header">
									<div class="card-actions">
										<a href="layouts-left-sidebar-panel-light.html#" class="card-action card-action-toggle" data-card-toggle></a>
										<a href="layouts-left-sidebar-panel-light.html#" class="card-action card-action-dismiss" data-card-dismiss></a>
									</div>
											...
											<div class="widget-profile-info">
												...
												<div class="profile-info">
													...
													<div class="profile-footer">
														<a href="layouts-left-sidebar-panel-light.html#">(edit profile)</a>
													</div>
												</div>
											</div>
										...
										<div id="accordion" class="w-100">
											<div class="card card-accordion card-accordion-first">
												<div class="card-header border-bottom-0">
													<h4 class="card-title">
														<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="layouts-left-sidebar-panel-light.html#collapse1One">
														...
														<ul class="widget-todo-list">
															<li>
																...
																<div class="todo-actions">
																	<a class="todo-remove" href="layouts-left-sidebar-panel-light.html#">
											...
											<div class="card card-accordion">
												<div class="card-header border-bottom-0">
													<h4 class="card-title">
														<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="layouts-left-sidebar-panel-light.html#collapse1Two">
								...
								<div class="card-body">
									<div class="content">
										...
										<div class="text-right">
											<a class="text-uppercase text-muted" href="layouts-left-sidebar-panel-light.html#">(View All)</a>
										</div>
									</div>
								</div>
			...
			<aside id="sidebar-right" class="sidebar-right">
				<div class="nano">
					<div class="nano-content">
						<a href="layouts-left-sidebar-panel-light.html#" class="mobile-close d-md-none">
