                ...
                <ul class="mobile-menu">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="index.html#">Product List Item Types</a></li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="index.html#">Variations</a>
                                <ul>
                            ...
                            <li>
                                <a href="index.html#">Product Layout Types</a>
                                <ul>
                    ...
                    <li>
                        <a href="<?php echo base_url() ?>assets/padma-home/demo-4/index.html#">Pages<span class="tip tip-hot">Hot!</span></a>
                        <ul>
                            <li><a href="<?php echo base_url() ?>assets/padma-home/demo-4/cart.html">Shopping Cart</a></li>
                            <li>
                                <a href="<?php echo base_url() ?>assets/padma-home/demo-4/index.html#">Checkout</a>
                                <ul>
                            ...
                            <li><a href="<?php echo base_url() ?>assets/padma-home/demo-4/about.html">About</a></li>
                            <li><a href="<?php echo base_url() ?>assets/padma-home/demo-4/index.html#" class="login-link">Login</a></li>
                    ...
                    <li><a href="contact.html">Contact Us</a></li>
                    <li><a href="index.html#">Special Offer!<span class="tip tip-hot">Hot!</span></a></li>
                    <li><a href="index.html#">Buy Porto!</a></li>
                </ul>
            </nav><!-- End .mobile-nav -->
