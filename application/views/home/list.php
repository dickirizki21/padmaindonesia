                        ...
                        <div class="col-lg-9">
                            <div class="home-slider owl-carousel owl-carousel-lazy">
                                <div class="home-slide">
                                    <div class="owl-lazy slide-bg" data-src="<?php echo base_url() ?>assets/padma-home/demo-4/assets/images/slider/slide-1.jpg"></div>
                                    <div class="home-slide-content text-white">
                                        <h3>Get up to <span>60%</span> off</h3>
                                        <h1>Summer Sale</h1>
                                        <p>Limited items available at this price.</p>
                                        <a href="<?php echo base_url() ?>assets/padma-home/demo-4/category.html" class="btn btn-dark">Shop Now</a>
                                    </div><!-- End .home-slide-content -->
                                </div><!-- End .home-slide -->

                                <div class="home-slide">
                                    <div class="owl-lazy slide-bg" data-src="<?php echo base_url() ?>assets/padma-home/demo-4/assets/images/slider/slide-2.jpg"></div>
                                ...
                                <div class="home-slide">
                                    <div class="owl-lazy slide-bg" data-src="<?php echo base_url() ?>assets/padma-home/demo-4/assets/images/slider/slide-3.jpg"></div>
                                    <div class="home-slide-content">
                        ...
                        <div class="product">
                            ...
                            <div class="product-details">
                                ...
                                <div class="product-action">
                                    <a href="index.html#" class="paction add-wishlist" title="Add to Wishlist">
                                    ...
                                    <a href="index.html#" class="paction add-compare" title="Add to Compare">
