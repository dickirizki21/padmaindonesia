                                ...
                                <div class="product">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="product-action">
                                            <a href="category-horizontal-filter1.html#" class="paction add-wishlist" title="Add to Wishlist">
                                            ...
                                            <a href="category-horizontal-filter1.html#" class="paction add-compare" title="Add to Compare">
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h2 class="product-title">
                                            <a href="product.html">Flexible Headset</a>
                                        </h2>
                                        <div class="price-box">
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h2 class="product-title">
                                            <a href="product.html">On-Ear Headset</a>
                                        </h2>
                                        <div class="price-box">
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h2 class="product-title">
                                            <a href="product.html">Tie Yellow</a>
                                        </h2>
                                        <div class="price-box">
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h2 class="product-title">
                                            <a href="product.html">White Drone</a>
                                        </h2>
                                        <div class="price-box">
                        ...
                        <div class="sidebar-wrapper">
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="category-horizontal-filter1.html#widget-body-1" role="button" aria-expanded="true" aria-controls="widget-body-1">electronics</a>
                                </h3>

                                <div class="collapse show" id="widget-body-1">
                                    <div class="widget-body">
                                        <ul class="cat-list">
                                            <li><a href="category-horizontal-filter1.html#">Smart TVs</a></li>
                                            <li><a href="category-horizontal-filter1.html#">Cameras</a></li>
                                            <li><a href="category-horizontal-filter1.html#">Head Phones</a></li>
                                            <li><a href="category-horizontal-filter1.html#">Games</a></li>
                                        </ul>
                                    </div><!-- End .widget-body -->
                                </div><!-- End .collapse -->
                            </div><!-- End .widget -->
                            ...
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="category-horizontal-filter1.html#widget-body-2" role="button" aria-expanded="true" aria-controls="widget-body-2">Price</a>
                                </h3>
                            ...
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="category-horizontal-filter1.html#widget-body-3" role="button" aria-expanded="true" aria-controls="widget-body-3">Size</a>
                                </h3>

                                <div class="collapse show" id="widget-body-3">
                                    <div class="widget-body">
                                        <ul class="config-size-list">
                                            <li><a href="category-horizontal-filter1.html#">S</a></li>
                                            <li class="active"><a href="category-horizontal-filter1.html#">M</a></li>
                                            <li><a href="category-horizontal-filter1.html#">L</a></li>
                                            <li><a href="category-horizontal-filter1.html#">XL</a></li>
                                            <li><a href="category-horizontal-filter1.html#">2XL</a></li>
                                            <li><a href="category-horizontal-filter1.html#">3XL</a></li>
                                        </ul>
                                    </div><!-- End .widget-body -->
                                </div><!-- End .collapse -->
                            </div><!-- End .widget -->
                            ...
                            <div class="widget">
                                <h3 class="widget-title">
                                    <a data-toggle="collapse" href="category-horizontal-filter1.html#widget-body-4" role="button" aria-expanded="true" aria-controls="widget-body-4">Brands</a>
                                </h3>

                                <div class="collapse show" id="widget-body-4">
                                    <div class="widget-body">
                                        <ul class="cat-list">
                                            <li><a href="category-horizontal-filter1.html#">Adidas <span>18</span></a></li>
                                            <li><a href="category-horizontal-filter1.html#">Camel <span>22</span></a></li>
                                            <li><a href="category-horizontal-filter1.html#">Seiko <span>05</span></a></li>
                                            <li><a href="category-horizontal-filter1.html#">Samsung Galaxy <span>68</span></a></li>
                                            <li><a href="category-horizontal-filter1.html#">Sony <span>03</span></a></li>
                                        </ul>
                                    </div><!-- End .widget-body -->
                                </div><!-- End .collapse -->
                            </div><!-- End .widget -->
                                ...
                                <div class="collapse show" id="widget-body-6">
                                    <div class="widget-body">
                                        <ul class="config-swatch-list">
                                            <li>
                                                <a href="category-horizontal-filter1.html#" style="background-color: #4090d5;"></a>
                                            </li>
                                            <li class="active">
                                                <a href="category-horizontal-filter1.html#" style="background-color: #f5494a;"></a>
                                            </li>
                                            <li>
                                                <a href="category-horizontal-filter1.html#" style="background-color: #fca309;"></a>
                                            </li>
                                            <li>
                                                <a href="category-horizontal-filter1.html#" style="background-color: #11426b;"></a>
                                            </li>
                                            <li>
                                                <a href="category-horizontal-filter1.html#" style="background-color: #f0f0f0;"></a>
                                            </li>
                                            <li>
                                                <a href="category-horizontal-filter1.html#" style="background-color: #3fd5c9;"></a>
                                            </li>
                                            <li>
                                                <a href="category-horizontal-filter1.html#" style="background-color: #979c1c;"></a>
                                            </li>
                                            <li>
                                                <a href="category-horizontal-filter1.html#" style="background-color: #7d5a3c;"></a>
                                            </li>
                                        </ul>
                                    </div><!-- End .widget-body -->
                                </div><!-- End .collapse -->
                                    ...
                                    <div class="owl-carousel widget-featured-products">
                                        <div class="featured-col">
                                            <div class="product product-sm">
                                                <figure class="product-image-container">
                                                    <a href="product.html" class="product-image">
                                                        <img src="<?php echo base_url() ?>assets/padma-home/demo-4/assets/images/products/small/product-1.jpg" alt="product">
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h2 class="product-title">
                                            ...
                                            <div class="product product-sm">
                                                <figure class="product-image-container">
                                                    <a href="product.html" class="product-image">
                                                        <img src="<?php echo base_url() ?>assets/padma-home/demo-4/assets/images/products/small/product-2.jpg" alt="product">
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h2 class="product-title">
                                            ...
                                            <div class="product product-sm">
                                                <figure class="product-image-container">
                                                    <a href="product.html" class="product-image">
                                                        <img src="<?php echo base_url() ?>assets/padma-home/demo-4/assets/images/products/small/product-3.jpg" alt="product">
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h2 class="product-title">
                                        ...
                                        <div class="featured-col">
                                            <div class="product product-sm">
                                                <figure class="product-image-container">
                                                    <a href="product.html" class="product-image">
                                                        <img src="<?php echo base_url() ?>assets/padma-home/demo-4/assets/images/products/small/product-4.jpg" alt="product">
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h2 class="product-title">
                                            ...
                                            <div class="product product-sm">
                                                <figure class="product-image-container">
                                                    <a href="product.html" class="product-image">
                                                        <img src="<?php echo base_url() ?>assets/padma-home/demo-4/assets/images/products/small/product-5.jpg" alt="product">
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h2 class="product-title">
                                            ...
                                            <div class="product product-sm">
                                                <figure class="product-image-container">
                                                    <a href="product.html" class="product-image">
                                                        <img src="<?php echo base_url() ?>assets/padma-home/demo-4/assets/images/products/small/product-6.jpg" alt="product">
                                                    </a>
                                                </figure>
                                                <div class="product-details">
                                                    <h2 class="product-title">
